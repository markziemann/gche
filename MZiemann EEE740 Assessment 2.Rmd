...
At the time I was not really "self aware" about the multiple facets that are required to deliver an effective learning experience to students, which can be summarised in the UK Professional Standards Framework (UKPSF) for teaching and supporting learning (Figure 1).
...
![__Figure 1. UK Professional Standards Framework (UKPSF) for teaching and supporting learning.__](https://knewmediadotnet.files.wordpress.com/2016/03/ukpsf2.jpg)
...
There were no genuine opportunities for students to network with one another and this was reflected in the discussion board comments. The area for student discussion recorded just one or two comments, while the questions directed to the Unit Chair were over 50. 
...
Up until this time, I had the illusion that I was a good teacher, but with feedback like that it was dawning upon me that students were not getting a genuine education, just going through the motions of completing assesments without appreciation for obtaining the relevant skills.
...
When Mazur changed his teaching style from teacher-centred lectures focused on the "transfer of information", to student centred and interactive sessions he saw that a bigger fraction could understand at a deeper level and better retain the knowledge and skills.
...
Another reason why this is important is because the university classroom these days is a much more diverse group than decades past (V4), so there is a greater chance for students to have relative strengths and weaknesses.
Without the opportunity to practise and seek feedback in a supportive environment, students with relatively lower starting ability will find it harder to improve, which speaks to V1 of the UKPSF.

Both events highlight necessary changes in the the education design for the unit. 
By first recognising the desirable pedagogical philosophy (Social Constructivism), I will be in a position to put in place a pedagogical strategy and practices that enable learning through preparation/completion of assessment tasks and participation in learning activities. 
...
* The systematic collection and analysis of student survey data, quiz scores and student results to get a better grasp upon whether changes in the design of the unit, assessment tasks and learning activities has had some tangible impact on student experience (V3). 
...
I've noticed in my previous teaching that students perform at a higher level when they present to their peers. 
...
If these measures were implemented, I would be looking to find evidence that they are working (V3). 
...
With regard to professional development, like to stay up to date with my content area (computational biology) by attending hands-on workshops and conferences, some of which are listd below.

* Introduction to Python: 1st - 3rd Oct 2013.

* Winter School in Mathematical & Computational Biology: 3rd - 7th July 2017.

* High Performance Computing with NCI: 19th June 2018

* Machine Learning to Deep Learning and Beyond: 26th - 28th November 2018.

These may only have a minor influence on my teaching, but I have learned some useful tactics.
...
Mazur mentions in his seminar (2013): "Education Is What Remains After You Have Forgotten Everything You Learned In School".
So as students, we are likely to forget much of the content of this course over time, but we are likely to retain knowledge of the threshold concepts because these shape our attitutes and actions immediately.

With regard to this I would suggest a few threshold concepts I've taken on board and and am now trying to incorporate in my routine teaching practice:
...
GitHub.com is a website used by software developers to keep track of changes in a software program, but I'm finding it quite useful to host all my documents (learning materials, assignments and other resources).
Students can ask questions and join a discussion with the "issues" feature.
Students can create their own content on GitHub including software and documents, which can form part of their assessments.
...
In my school there currently is a unit chair in a first year science topic which has several hundred students, who I could ask for tactics, to attend one of their lectures, or even to become my teaching mentor.
...
In addition, I can do my own further research on the topic of active learning strategies including the scientific and popular literature.
...
On the other hand these activities are very time consuming and in my view at least, these endeavours are not deemed as important to the LES school (and my prospects for career advancement) as research papers and grants.
It may be worthwhile speaking to my line manager about this.
...
It looks as if I will be teaching in all three trimesters this year 2020 and as such there just won't be enough time to fit these in alongside my routine teaching, research and other duties. 
...
On the 16th June, there is an upcoming SEBE Induction for new Unit Chairs and new teaching /lecturing staff via Zoom. Although it is designed for new staff, I think I could benefit by attending and learning a bit more about the newer technological features of cloudDeakin and some of the procedural/administration changes in recent times.
...
I will be applying evidenced based teaching practices described above and make that a part of my professional development (V3).
